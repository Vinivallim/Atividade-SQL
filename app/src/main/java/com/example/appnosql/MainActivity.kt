...
fun addDataToDatabase(
    ...
    Column(
        ...
        Text(
            ...
            text = "DataBase SQLite no Android",
        ...
        TextField(
            ...
            placeholder = { Text(text = "Digite o nome do seu curso") },
        ...
        TextField(
            ...
            // on below line we are adding place holder as text as "Enter your email"
            placeholder = { Text(text = "Digite a duração do seu curso") },
            // on below line we are adding modifier to it
            // and adding padding to it and filling max width
            modifier = Modifier
                .fillMaxWidth(),
        ...
        TextField(
            ...
            placeholder = { Text(text = "Entre com sua materia") },
            // on below line we are adding modifier to it
            // and adding padding to it and filling max width
            modifier = Modifier
                .fillMaxWidth(),
        ...
        TextField(
            ...
            // on below line we are adding place holder as text as "Enter your email"
            placeholder = { Text(text = "Entre com a descrição do seu curso") },
            // on below line we are adding modifier to it
            // and adding padding to it and filling max width
            modifier = Modifier
                .fillMaxWidth(),
        ...
        Button(onClick = {
            ...
            Toast.makeText(context, "Curso adicionado no banco de dados", Toast.LENGTH_SHORT).show()
        }) {
            // on below line adding a text for our button.
            Text(text = "Adicionar curso ao banco de dados", color = Color.Black)
        }
        ...
        Button(onClick = {
            ...
            // on below line adding a text for our button.
            Text(text = "Leia os cursos no Banco de dados", color = Color.Black)
        }
    }
}
